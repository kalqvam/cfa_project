...
corr_matrix["ratio_employee", "ratio_other"] <- 0.24
corr_matrix["ratio_other", "ratio_employee"] <- 0.24

corr_matrix["ratio_employee", "growth_intangibles"] <- 0
corr_matrix["growth_intangibles", "ratio_employee"] <- 0

# Other operating expenses correlations
corr_matrix["ratio_other", "growth_intangibles"] <- 0
corr_matrix["growth_intangibles", "ratio_other"] <- 0
  
# NWC correlation matrix
variable_names <- c(
